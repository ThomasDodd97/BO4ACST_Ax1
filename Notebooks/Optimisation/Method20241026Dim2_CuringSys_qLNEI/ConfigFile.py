...
class OptimisationSetup_class(object):
    def __init__(self):
        ...
        self.TailoredExperiment_str = "Method20241026Dim2"
        ...
        self.AUPR1_UPR1vsDMA_Constant_DecPct_flt = 0.999 # 99.9% UPR1 (0.1% DMA) # c3
        self.IAUPR1_AUPR1vsI1_Bounds_DecPct_lis = [0.5,0.9] # 50-90% AUPR1 (50-10% I1) # x2
        ...
        self.Parameters_lis = [
            ...
            {"name":"x2", "type":"range","bounds":self.IAUPR1_AUPR1vsI1_Bounds_DecPct_lis,"value_type":"float"}
        ]
        ...
        self.NoOfPriorSamples_int = int(4)
